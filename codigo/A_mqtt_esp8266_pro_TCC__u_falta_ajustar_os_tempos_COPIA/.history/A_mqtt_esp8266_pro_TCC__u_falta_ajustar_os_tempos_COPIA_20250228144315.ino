...
#define servidor_mqtt             "hurricanecloud384.cloud.shiftr.io"  //URL do servidor MQTT
#define servidor_mqtt_porta       "1883"  //Porta do servidor (a mesma deve ser informada na variável abaixo)
#define servidor_mqtt_usuario     "hurricanecloud384"  //Usuário
#define servidor_mqtt_senha       "umaSenhaSimples"  //Senha
